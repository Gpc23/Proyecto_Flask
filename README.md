...
Ejercicio de Libreria en el que debemos crear una aplicación dinámica en python flask con las siguientes características:

    Escoge una plantilla html5 gratuita y úsala para crear una plantilla base.html. = https://html5up.net/directive
